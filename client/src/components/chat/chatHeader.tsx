...
import { StreamDialog } from "@/components/stream/streamDialog";
...
export function ChatHeader({ name, avatar, online, onBack, showBackButton = false, chatId }: ChatHeaderProps) {
